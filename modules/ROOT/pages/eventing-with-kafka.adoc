...
include::knative-tutorial-basics:ROOT:partial$eventing-snippets.adoc[tag=eventing-nav-folder]
...
releases/download/]{knative-eventing-version}pass:q[/kafka-channel.yaml" \
...
<.> This is another example of a direct xref:knative-tutorial-basics:ROOT:eventing/eventing-src-to-sink.adoc.adoc#eventing-sink-service[Source to Sink]
