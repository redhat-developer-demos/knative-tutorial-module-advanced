...
- *Event Trigger*: This is xref:eventing/eventing-trigger-broker.adoc[Knative Event Trigger] that apply a filter on the processed data, to send to the Event Subscriber
...
----
copyToClipboard::run-label-namespace[]
--
oc::
+
--
endif::[]
[#run-label-namespace-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc label namespace {tutorial-namespace} knative-eventing-injection=enabled
----
copyToClipboard::run-label-namespace-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::watch-default-broker-pods[]
--
oc::
+
--
endif::[]
[#watch-default-broker-pods-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch oc get pods -n {tutorial-namespace}
----
copyToClipboard::watch-default-broker-pods-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::kamel-cbr-deploy-fruit-producer[]
...
----
copyToClipboard::kamel-cbr-call-fp[]
...
----
copyToClipboard::kamel-cbr-kafka-consumer[]
...
----
copyToClipboard::kamel-deploy-data-processor[]
--
oc::
+
--
endif::[]
[#kamel-deploy-data-processor-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc apply -n {tutorial-namespace} -f eip/fruits-processor.yaml
----
copyToClipboard::kamel-deploy-data-processor-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::kamel-cbr-query-camelsources[]
--
oc::
+
--
endif::[]
[#kamel-cbr-query-camelsources-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch oc get  -n {tutorial-namespace} camelsources
----
copyToClipboard::kamel-cbr-query-camelsources-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::kamel-cbr-deploy-event-sub[]
--
oc::
+
--
endif::[]
[#kamel-cbr-deploy-event-sub-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc apply -n {tutorial-namespace} \
  -f $TUTORIAL_HOME/install/utils/fruit-events-display.yaml
----
copyToClipboard::kamel-cbr-deploy-event-sub-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::kamel-open-fruit-ui[]
--
OpenShift::
+
--
...
----
copyToClipboard::kamel-open-fruit-expose[]
...
----
copyToClipboard::kamel-open-fruit-rt[]
...
----
copyToClipboard::kamel-cbr-deploy-trigger[]
--
oc::
+
--
endif::[]
[#kamel-cbr-deploy-trigger-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc apply -n {tutorial-namespace} -f eip/sugary-fruits.yaml
----
copyToClipboard::kamel-cbr-deploy-trigger-oc[]
ifndef::workshop[]
--
endif::[]
====
...
----
copyToClipboard::kamel-cbr-list-triggers[]
--
oc::
+
--
endif::[]
[#kamel-cbr-list-triggers-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc -n {tutorial-namespace} get triggers
----
copyToClipboard::kamel-cbr-list-triggers-oc[]
ifndef::workshop[]
--
endif::[]
====
...
$TUTORIAL_HOME/bin/call.sh fruits-producer ''
----
copyToClipboard::kamel-cbr-e2e-run[]
...
[#camelk-cbr-cleanup-oc]
[source,bash,subs="+quotes,+attributes,+macros"]
----
kamel delete  -n {tutorial-namespace} fruit-producer
oc delete  -n {tutorial-namespace} -f -f eip/fruits-processor.yaml
oc delete -n {tutorial-namespace} -f $TUTORIAL_HOME/install/utils/fruit-events-display.yaml
----
copyToClipboard::camelk-cbr-cleanup-oc[]
ifndef::workshop[]
--
endif::[]
====
